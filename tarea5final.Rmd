...
Calcule E(b0),E(b1), var(b0) y var(b1) para muestras de tamaños 50, 100, 500, 1000. ¿Existe sesgo?, ¿Desaparece el sesgo a medida que el tama?o de la muestra aumenta?
...
Se observa que existe sesgo, el que no disminuye al aumentar el tama?o de la muestra. Al observarse un comportamiento bastante volátil, se nota que los estimadores no lograr?n ser insesgados asintoticamente.

# Parte b caso 1

Grafique la distribución de b1 para tamaños de muestra n = 50, 100, 500, 1000
...
Se observa que sigue sin ser insesgados asintoticamente los estimadores, pero se nota una disminución constante en el sesgo de b0 al aumentar el tamaño de la muestra, teniendo x2 una distribución constante.
...
Es posible observar que la media varía con la distribución uniforme de x2, por que logra capturar el efecto que no se incluía en el caso 1.
